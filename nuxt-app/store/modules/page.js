...
const actions = {
    ...
    initPageOption(context) {
        context.commit('initPageOption');
    },
    ...
    setCurrentPageIndex(context, currentPageIndex) {
        context.commit('currentPageIndex', currentPageIndex);
    },
